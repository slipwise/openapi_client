...
# Unit tests for OpenapiClient::CustomDataTypeRecord
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CustomDataTypeRecord do
  let(:instance) { OpenapiClient::CustomDataTypeRecord.new }

  describe 'test an instance of CustomDataTypeRecord' do
    it 'should create an instance of CustomDataTypeRecord' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CustomDataTypeRecord)
    end
  end
