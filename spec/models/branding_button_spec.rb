...
# Unit tests for OpenapiClient::BrandingButton
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::BrandingButton do
  let(:instance) { OpenapiClient::BrandingButton.new }

  describe 'test an instance of BrandingButton' do
    it 'should create an instance of BrandingButton' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::BrandingButton)
    end
  end
  ...
  describe 'test attribute "hover"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
