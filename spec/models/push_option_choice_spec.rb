...
# Unit tests for OpenapiClient::PushOptionChoice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PushOptionChoice do
  let(:instance) { OpenapiClient::PushOptionChoice.new }

  describe 'test an instance of PushOptionChoice' do
    it 'should create an instance of PushOptionChoice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PushOptionChoice)
    end
  end
