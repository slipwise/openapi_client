...
# Unit tests for OpenapiClient::CustomDataTypeRecords
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CustomDataTypeRecords do
  let(:instance) { OpenapiClient::CustomDataTypeRecords.new }

  describe 'test an instance of CustomDataTypeRecords' do
    it 'should create an instance of CustomDataTypeRecords' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CustomDataTypeRecords)
    end
  end
