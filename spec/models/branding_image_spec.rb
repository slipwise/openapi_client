...
# Unit tests for OpenapiClient::BrandingImage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::BrandingImage do
  let(:instance) { OpenapiClient::BrandingImage.new }

  describe 'test an instance of BrandingImage' do
    it 'should create an instance of BrandingImage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::BrandingImage)
    end
  end
