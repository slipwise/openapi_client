...
# Unit tests for OpenapiClient::ErrorValidation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ErrorValidation do
  let(:instance) { OpenapiClient::ErrorValidation.new }

  describe 'test an instance of ErrorValidation' do
    it 'should create an instance of ErrorValidation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ErrorValidation)
    end
  end
