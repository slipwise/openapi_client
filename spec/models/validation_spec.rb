...
# Unit tests for OpenapiClient::Validation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Validation do
  let(:instance) { OpenapiClient::Validation.new }

  describe 'test an instance of Validation' do
    it 'should create an instance of Validation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Validation)
    end
  end
