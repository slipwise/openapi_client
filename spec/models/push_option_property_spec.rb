...
# Unit tests for OpenapiClient::PushOptionProperty
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PushOptionProperty do
  let(:instance) { OpenapiClient::PushOptionProperty.new }

  describe 'test an instance of PushOptionProperty' do
    it 'should create an instance of PushOptionProperty' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PushOptionProperty)
    end
  end
