...
# Unit tests for OpenapiClient::GroupPrototype
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GroupPrototype do
  let(:instance) { OpenapiClient::GroupPrototype.new }

  describe 'test an instance of GroupPrototype' do
    it 'should create an instance of GroupPrototype' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::GroupPrototype)
    end
  end
