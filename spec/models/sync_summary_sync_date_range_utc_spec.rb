...
# Unit tests for OpenapiClient::SyncSummarySyncDateRangeUtc
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SyncSummarySyncDateRangeUtc do
  let(:instance) { OpenapiClient::SyncSummarySyncDateRangeUtc.new }

  describe 'test an instance of SyncSummarySyncDateRangeUtc' do
    it 'should create an instance of SyncSummarySyncDateRangeUtc' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::SyncSummarySyncDateRangeUtc)
    end
  end
