...
# Unit tests for OpenapiClient::HalRef
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::HalRef do
  let(:instance) { OpenapiClient::HalRef.new }

  describe 'test an instance of HalRef' do
    it 'should create an instance of HalRef' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::HalRef)
    end
  end
