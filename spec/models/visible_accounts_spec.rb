...
# Unit tests for OpenapiClient::VisibleAccounts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::VisibleAccounts do
  let(:instance) { OpenapiClient::VisibleAccounts.new }

  describe 'test an instance of VisibleAccounts' do
    it 'should create an instance of VisibleAccounts' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::VisibleAccounts)
    end
  end

  describe 'test attribute "visible_accounts"' do
    it 'should work' do
