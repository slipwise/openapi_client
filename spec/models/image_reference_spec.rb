...
# Unit tests for OpenapiClient::ImageReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ImageReference do
  let(:instance) { OpenapiClient::ImageReference.new }

  describe 'test an instance of ImageReference' do
    it 'should create an instance of ImageReference' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ImageReference)
    end
  end
