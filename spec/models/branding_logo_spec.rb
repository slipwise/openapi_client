...
# Unit tests for OpenapiClient::BrandingLogo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::BrandingLogo do
  let(:instance) { OpenapiClient::BrandingLogo.new }

  describe 'test an instance of BrandingLogo' do
    it 'should create an instance of BrandingLogo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::BrandingLogo)
    end
  end
