...
# Unit tests for OpenapiClient::PushValidationInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PushValidationInfo do
  let(:instance) { OpenapiClient::PushValidationInfo.new }

  describe 'test an instance of PushValidationInfo' do
    it 'should create an instance of PushValidationInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PushValidationInfo)
    end
  end
