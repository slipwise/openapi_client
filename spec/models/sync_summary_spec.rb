...
# Unit tests for OpenapiClient::SyncSummary
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SyncSummary do
  let(:instance) { OpenapiClient::SyncSummary.new }

  describe 'test an instance of SyncSummary' do
    it 'should create an instance of SyncSummary' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::SyncSummary)
    end
  end

  describe 'test attribute "sync_date_range_utc"' do
    it 'should work' do
  ...
  describe 'test attribute "commerce_sync_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
