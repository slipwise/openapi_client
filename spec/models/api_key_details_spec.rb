...
# Unit tests for OpenapiClient::ApiKeyDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ApiKeyDetails do
  let(:instance) { OpenapiClient::ApiKeyDetails.new }

  describe 'test an instance of ApiKeyDetails' do
    it 'should create an instance of ApiKeyDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ApiKeyDetails)
    end
  end
