...
# Unit tests for OpenapiClient::SyncFlowUrl
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SyncFlowUrl do
  let(:instance) { OpenapiClient::SyncFlowUrl.new }

  describe 'test an instance of SyncFlowUrl' do
    it 'should create an instance of SyncFlowUrl' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::SyncFlowUrl)
    end
  end
