...
# Unit tests for OpenapiClient::SyncRangeDateRange
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SyncRangeDateRange do
  let(:instance) { OpenapiClient::SyncRangeDateRange.new }

  describe 'test an instance of SyncRangeDateRange' do
    it 'should create an instance of SyncRangeDateRange' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::SyncRangeDateRange)
    end
  end
