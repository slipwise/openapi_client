...
# Unit tests for OpenapiClient::SourceType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SourceType do
  let(:instance) { OpenapiClient::SourceType.new }

  describe 'test an instance of SourceType' do
    it 'should create an instance of SourceType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::SourceType)
    end
  end
