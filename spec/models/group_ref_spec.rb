...
# Unit tests for OpenapiClient::GroupRef
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GroupRef do
  let(:instance) { OpenapiClient::GroupRef.new }

  describe 'test an instance of GroupRef' do
    it 'should create an instance of GroupRef' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::GroupRef)
    end
  end
