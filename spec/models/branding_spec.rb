...
# Unit tests for OpenapiClient::Branding
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Branding do
  let(:instance) { OpenapiClient::Branding.new }

  describe 'test an instance of Branding' do
    it 'should create an instance of Branding' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Branding)
    end
  end
