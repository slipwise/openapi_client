...
# Unit tests for OpenapiClient::PushChangeType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PushChangeType do
  let(:instance) { OpenapiClient::PushChangeType.new }

  describe 'test an instance of PushChangeType' do
    it 'should create an instance of PushChangeType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PushChangeType)
    end
  end
