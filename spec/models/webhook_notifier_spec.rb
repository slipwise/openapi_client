...
# Unit tests for OpenapiClient::WebhookNotifier
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WebhookNotifier do
  let(:instance) { OpenapiClient::WebhookNotifier.new }

  describe 'test an instance of WebhookNotifier' do
    it 'should create an instance of WebhookNotifier' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::WebhookNotifier)
    end
  end
