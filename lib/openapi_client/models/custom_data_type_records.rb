  ...
  class CustomDataTypeRecords
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::CustomDataTypeRecords` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::CustomDataTypeRecords`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@page_size.nil? && @page_size > 2000
        invalid_properties.push('invalid value for "page_size", must be smaller than or equal to 2000.')
      end
    ...
    def valid?
      ...
      return false if !@page_size.nil? && @page_size > 2000
      true
    end
    ...
    def page_size=(page_size)
      ...
      if page_size > 2000
        fail ArgumentError, 'invalid value for "page_size", must be smaller than or equal to 2000.'
      end
    ...
    def hash
      [results, page_number, page_size, total_results].hash
    end
