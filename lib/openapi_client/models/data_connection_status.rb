...
module OpenapiClient
  class DataConnectionStatus
    PENDING_AUTH = "PendingAuth".freeze
    LINKED = "Linked".freeze
    UNLINKED = "Unlinked".freeze
    DEAUTHORIZED = "Deauthorized".freeze

    def self.all_vars
      @all_vars ||= [PENDING_AUTH, LINKED, UNLINKED, DEAUTHORIZED].freeze
    end
    ...
    def build_from_hash(value)
      return value if DataConnectionStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #DataConnectionStatus"
    end
  end
end
