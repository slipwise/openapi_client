...
module OpenapiClient
  ...
  class DataStatus
    ...
    attr_accessor :latest_sync_id

    # Unique identifier for the most recent successful sync of data type.
    attr_accessor :latest_successful_sync_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::DataStatus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::DataStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'latest_sync_id')
        self.latest_sync_id = attributes[:'latest_sync_id']
      end

      if attributes.key?(:'latest_successful_sync_id')
        self.latest_successful_sync_id = attributes[:'latest_successful_sync_id']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @last_successful_sync.nil?
        invalid_properties.push('invalid value for "last_successful_sync", last_successful_sync cannot be nil.')
      end
    ...
    def data_type=(data_type)
      validator = EnumAttributeValidator.new('String', ["accountTransactions", "balanceSheet", "bankAccounts", "bankTransactions", "billCreditNotes", "billPayments", "bills", "cashFlowStatement", "chartOfAccounts", "company", "creditNotes", "customers", "directCosts", "directIncomes", "invoices", "itemReceipts", "items", "journalEntries", "journals", "paymentMethods", "payments", "profitAndLoss", "purchaseOrders", "salesOrders", "suppliers", "taxRates", "trackingCategories", "transfers", "banking-accountBalances", "banking-accounts", "banking-transactionCategories", "banking-transactions", "commerce-companyInfo", "commerce-customers", "commerce-disputes", "commerce-locations", "commerce-orders", "commerce-paymentMethods", "commerce-payments", "commerce-productCategories", "commerce-products", "commerce-taxComponents", "commerce-transactions"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          latest_sync_id == o.latest_sync_id &&
          latest_successful_sync_id == o.latest_successful_sync_id
    end
    ...
    def hash
      [data_type, last_successful_sync, current_status, latest_sync_id, latest_successful_sync_id].hash
    end
