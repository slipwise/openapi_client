...
module OpenapiClient
  ...
  class CustomDataTypeConfiguration
    ...
    def self.openapi_types
      {
        :'data_source' => :'String',
        :'required_data' => :'Hash<String, String>',
        :'key_by' => :'Array<String>',
        :'source_modified_date' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::CustomDataTypeConfiguration` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::CustomDataTypeConfiguration`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'key_by')
        if (value = attributes[:'key_by']).is_a?(Array)
          self.key_by = value
        end
      end

      if attributes.key?(:'source_modified_date')
        if (value = attributes[:'source_modified_date']).is_a?(Array)
          self.source_modified_date = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          key_by == o.key_by &&
          source_modified_date == o.source_modified_date
    end
    ...
    def hash
      [data_source, required_data, key_by, source_modified_date].hash
    end
