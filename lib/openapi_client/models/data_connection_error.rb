  ...
  class DataConnectionError
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::DataConnectionError` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::DataConnectionError`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'errored_on_utc')
        self.errored_on_utc = attributes[:'errored_on_utc']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          errored_on_utc == o.errored_on_utc
    end
    ...
    def hash
      [status_code, status_text, error_message, errored_on_utc].hash
    end
