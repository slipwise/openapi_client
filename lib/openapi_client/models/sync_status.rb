...
module OpenapiClient
  ...
  class SyncStatus
    ...
    def hash
      [commerce_sync_id, sync_id, sync_status_code, sync_status, error_message, sync_exception_message, sync_utc, data_pushed, data_connections].hash
    end
