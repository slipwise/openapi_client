...
module OpenapiClient
  ...
  class DataTypeFeature
    ...
    def self.openapi_types
      {
        :'data_type' => :'String',
        :'supported_features' => :'Array<SupportedFeature>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::DataTypeFeature` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::DataTypeFeature`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @supported_features.nil?
        invalid_properties.push('invalid value for "supported_features", supported_features cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @supported_features.nil?
      true
    end
    ...
    def hash
      [data_type, supported_features].hash
    end
